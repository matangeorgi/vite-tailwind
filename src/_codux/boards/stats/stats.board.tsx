            ...
            <div className="container px-4 mx-auto">
                <div className="flex flex-wrap items-center -mx-4 -mb-8">
                    <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 text-center">
                        ...
                        <h3 className="mb-2 text-2xl font-bold font-heading">China Market</h3>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 text-center">
                        ...
                        <h3 className="mb-2 text-2xl font-bold font-heading">US Market</h3>
                        <p className="text-gray-500 text-lg">Dolor sit amet consectutar</p>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 text-center">
                        ...
                        <h3 className="mb-2 text-2xl font-bold font-heading">EU Market</h3>
                        <p className="text-gray-500 text-lg">Dolor sit amet consectutar</p>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 text-center">
                        ...
                        <h3 className="mb-2 text-2xl font-bold font-heading">UK Market</h3>
                        <p className="text-gray-500 text-lg">Dolor sit amet consectutar</p>
                    </div>
                </div>
            </div>
