...
import styles from './code-in-component.module.scss';

export interface CodeInComponentProps {
    className?: string;
}
 ...
 */
export const CodeInComponent = ({ className }: CodeInComponentProps) => {
    return(
        <div className="bg-white py-24 sm:py-32">asdsadsa
    ...
    <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
      <div className="p-8 sm:p-10 lg:flex-auto">
        ...
        <div className="mt-10 flex items-center gap-x-4">
          ...
          <div className="h-px flex-auto bg-gray-100 bg"></div>
        </div>
